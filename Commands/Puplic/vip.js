...
module.exports = {
  ...
  run: async (client, message) => {
    ...
    const deleteButton = new ButtonBuilder()
      .setCustomId('Cancel3')
      .setLabel('إلغاء')
      .setEmoji("<:no:1223331245434343577>")
